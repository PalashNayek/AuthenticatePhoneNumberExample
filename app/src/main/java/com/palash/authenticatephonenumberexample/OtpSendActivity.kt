...
import com.palash.authenticatephonenumberexample.databinding.ActivityOtpSendBinding
...
class OtpSendActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSend.setOnClickListener {
            ...
            Log.d("MyssNumber",""+phoneNumber)

            otpSend("$countryCode$number")
        }
    }
    private fun getPhoneNumber(phone: String): String? {
        if (phone.isEmpty())
            ...
            Callback(this).onToast("Valid phone number!")
        else
...
//                super.onCodeSent(verificationId, token)
        ...
        Log.d("MyPhoneNo","$phoneNumberWithCountryCode")
    }
